...
const BIN = new Set(['png', 'jpg', 'jpeg', 'webp', 'gif', 'ico', 'woff2', 'woff', 'ttf', 'bin', 'mp3']);
...
export function langOf(ext) {
  return ({ ts: 'TypeScript', tsx: 'TypeScript React', js: 'JavaScript', jsx: 'JavaScript React',
    ...
    yaml: 'YAML', sh: 'Shell', bash: 'Shell', conf: 'Config', toml: 'TOML', xml: 'XML',
    log: 'Journal', bak: 'Sauvegarde', patch: 'Patch', bin: 'Binaire', mp3: 'Audio',
    ico: 'Icon', svg: 'SVG', png: 'PNG', jpg: 'JPEG', webp: 'WebP', html: 'HTML',
